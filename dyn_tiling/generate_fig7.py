...
csv_files = [
    './dyn_tiling/figure_7_mixtral_b1024_raw.csv',  
    './dyn_tiling/figure_7_qwen_b1024_raw.csv',         
    
]

x_labels_list = [
    ['Tile=256','Tile=1024','Dynamic', ],
    ['Tile=256','Tile=1024','Dynamic', ]
]
...
fig.savefig('./dyn_tiling/figure7.pdf', dpi=300, bbox_inches='tight')
fig.savefig('./dyn_tiling/figure7.png', bbox_inches='tight')